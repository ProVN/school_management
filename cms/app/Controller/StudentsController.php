					...
					if (isset($student['StudentInfo'])) {
						...
						foreach ($student['StudentInfo']['name'] as $key12 => $student_info_name) {
							if ($student_info_name != "") {
								$studentInfo = array('StudentInfo' => array('id' => null, 'student_id' => $this -> Student -> getLastInsertID(), 'name' => $student_info_name, 'value' => $student['StudentInfo']['value'][$key12], ));
	...
	public function edit($id) {
		...
		if ($student == null) {
			...
			if (empty($this -> data)) {
				...
				foreach ($student['StudentInfo']['name'] as $key12 => $student_info_name) {
					if ($student_info_name != "") {
						$studentInfo = array('StudentInfo' => array('id' => null, 'student_id' => $id, 'name' => $student_info_name, 'value' => $student['StudentInfo']['value'][$key12], ));
						$this -> StudentInfo -> save($studentInfo);
					}
				}
